...
namespace VirtualGrasp.Tutorials
{
    ...
    public class TutorialCallbacks : ScriptableObject
    {
        ...
        public bool OneAvatarIsFingerControlled()
        {
            ...
            VG_ControllerProfile handProfile = Resources.Load<VG_ControllerProfile>("VG_ControllerProfiles/VG_EC_OculusHand");
        ...
        {
            VG_EC_OculusHand controller = new VG_EC_OculusHand(0, VG_HandSide.LEFT, false);
        ...
        {
            foreach (string f in Directory.GetFiles("Assets", "*.db"))
            {
        ...
        public bool DebugFilesCreated()
        {
            ...
            double diff = System.DateTime.Now.Subtract(Directory.GetLastWriteTime("Assets/vg_tmp")).TotalSeconds;
            return (diff < 60);
        }
